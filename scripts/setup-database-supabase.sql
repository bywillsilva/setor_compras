...
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS created_by_nome TEXT;
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS cliente_id BIGINT REFERENCES clientes(id) ON DELETE CASCADE;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS valor_contrato NUMERIC(15, 2) DEFAULT 0;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS ordem INT DEFAULT 1;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP;

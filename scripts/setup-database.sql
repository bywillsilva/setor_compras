...
ALTER TABLE notificacoes ADD COLUMN IF NOT EXISTS link VARCHAR(500) NULL;
ALTER TABLE notificacoes ADD COLUMN IF NOT EXISTS lida BOOLEAN DEFAULT FALSE;
ALTER TABLE notificacoes ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE notificacoes ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE notificacoes ADD COLUMN IF NOT EXISTS read_at TIMESTAMP NULL;
...
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS created_by_nome VARCHAR(255) NOT NULL;
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE resumos_contratos ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS cliente_id BIGINT NOT NULL;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS valor_contrato DECIMAL(15, 2) NOT NULL DEFAULT 0;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS ordem INT NOT NULL DEFAULT 1;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE resumo_contrato_itens ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
